...
save_plot(plot = FeatureScatter(multiplexed.test1, feature1 = "TotalSeqB1", feature2 = "TotalSeqB3"),'../Demultiplexing_R/plots/scatterplot_quant_0.99_raw.png')
table(multiplexed.test1$HTO_classification.global)
save_plot(plot = RidgePlot(multiplexed.test1, assay = "HTO", features = rownames(multiplexed[["HTO"]])),'../Demultiplexing_R/plots/ridgeplot_quant_0.99_raw.png',base_height = 20, base_width = 20)      

multiplexed.test2 <- HTODemux(multiplexed, assay = "HTO", positive.quantile = 0.995)
save_plot(plot = FeatureScatter(multiplexed.test2, feature1 = "TotalSeqB1", feature2 = "TotalSeqB3"),'../Demultiplexing_R/plots/scatterplot_quant_0.995_raw.png')
table(multiplexed.test2$HTO_classification.global)
save_plot(plot = RidgePlot(multiplexed.test2, assay = "HTO", features = rownames(multiplexed[["HTO"]])),'../Demultiplexing_R/plots/ridgeplot_quant_0.995_raw.png',base_height = 20, base_width = 20)

multiplexed.test3 <- HTODemux(multiplexed, assay = "HTO", positive.quantile = 0.95)
save_plot(plot = FeatureScatter(multiplexed.test3, feature1 = "TotalSeqB1", feature2 = "TotalSeqB3"),'../Demultiplexing_R/plots/scatterplot_quant_0.95_raw.png')
table(multiplexed.test3$HTO_classification.global)
save_plot(plot = RidgePlot(multiplexed.test3, assay = "HTO", features = rownames(multiplexed[["HTO"]])),'../Demultiplexing_R/plots/ridgeplot_quant_0.95_raw.png',base_height = 20, base_width = 20)

multiplexed.test4 <- HTODemux(multiplexed, assay = "HTO", positive.quantile = 0.9995)
save_plot(plot = FeatureScatter(multiplexed.test4, feature1 = "TotalSeqB1", feature2 = "TotalSeqB3"),'../Demultiplexing_R/plots/scatterplot_quant_0.9995_raw.png')
table(multiplexed.test4$HTO_classification.global)
save_plot(plot = RidgePlot(multiplexed.test4, assay = "HTO", features = rownames(multiplexed[["HTO"]])),'../Demultiplexing_R/plots/ridgeplot_quant_0.9995_raw.png',base_height = 20, base_width = 20)
...
table
png("../Demultiplexing_R/plots/barplot_quant_0.9995_raw.png", width = 800, height = 600)
...
save_plot(plot = DimPlot(multiplexed.negatives) ,'../Demultiplexing_R/plots/umap_singlet_doublets_raw.png')
...
save_plot(plot = DimPlot(multiplexed.clustering,group.by = "HTO_classification"), '../Demultiplexing_R/plots/umap_hashtags_raw.png')

#Check the distribution of doublets/singlets/negative cells by looking at the Global classification results
table <- table(multiplexed.clustering$HTO_classification)
table
png("../Demultiplexing_R/plots/barplot_quant_0.9995_hash_raw.png")
par(mar = c(8, 4, 4, 2)) 
...
save_plot(plot = VlnPlot(multiplexed, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3),'../Demultiplexing_R/plots/violinplots_before_filtering_raw.png')

# Filter based on QC thresholds
multiplexed <- subset(multiplexed, subset = percent.mt < 20 & nCount_RNA < 30000 & nFeature_RNA < 7000)
save_plot(plot = VlnPlot(multiplexed, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3),'../Demultiplexing_R/plots/violinplots_after_filtering_raw.png')
...
write.csv(A1_multiplexed.labels, '../hashtags_demultiplex_raw.csv')
save(multiplexed, file = "../hashtags_demultiplexing_raw.Robj")